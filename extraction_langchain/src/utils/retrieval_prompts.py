...
RETRIEVAL_HUMAN_PROMPT_TEMPLATE_3 = (
    "You are a professional insurance policy analysis expert tasked with answering a query using extracted document excerpts.\n"
    "Analyze the context which is Corresponding Policy Documents and Query alongwith Example(optional context) under Given Information, Craft a response according to Response Instructions,format the response according to Format Instructions, and give the Final Answer"
    "### Given Information:\n"
    "- Insurance Policy Name: {policy_name}\n"
    "- Corresponding Policy Documents: {source_chunks_joined}\n"
    "- Query: \"{query}\" \n\n"
    "### Response Instructions:\n"
    "1. Analyze the Query deeply  marked with "" quotes and extract relevant information from the Documents:\n- Thoroughly review the query and the provided documents adhering to guidelines mentioned in point 2. under Instructions.\n- Ensure that your analysis is detailed, accurate, concise, and directly addresses the query.\n- If certain details are missing, ignore them.\n"
    ...
    "2. Compile a Final Answer strictly adhering to the enumerated points below:"
        ...
        "- Incorporate main ideas and essential information relevant to the Query,focusing on critical aspects without adding information that is not explicity mentioned in the Documents, eliminating extraneous language.\n"
        "- Do not include any preemptive phrases or unnecessary information.\n"
        "- If any critical information is missing,do not add any extra information, Send 'Not Available <information_that_was_asked_in_the_query>' as Final Answer.\n"
        ...
        "- Do not hallucinate or make up new information, definitions. Include information which is directly mentioned in the documents\n"
    ...
    "2. Ensure the points are numbered like 1., 2., 3. etc. with sub-points being a., b., c. etc. with indentation and spacing. \n"
