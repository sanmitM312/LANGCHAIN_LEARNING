USER_QUERIES = { 
                  #   "distribution_channel" : "What are the distribution channels available for this policy like is this online-only, offline-only or online and offline both?",
                    "plan_options" : "What are the plan options available for the policy? Give brief description of each plan option.", 
                    "plan_description" : "What are the Key Features/benefits of the policy?",
                    ...
                    "death_benefits" : "What are the death benefits available for this policy?For e.g - Death benefits is higher/highest of - .Stick to percentages and exclude specific amounts, included as examples in the policy document.", 
                    ...
                    "exit_options" : "State the Exit values/options/benefits available for the policy for eg. Smart Exit Option? Exclude surrender benefits and paid-up value.",
                    ...
                    "surrender_value_factor" : "What is the surrender value/benefit factor(SVF) or Policy Cancellation Value (PCV) Factor Formula  for the policy?",
                    "surrender_benefits" :  "What is/are the surrender value/benefits for this policy? Exclude paid-up value and exit options.",
